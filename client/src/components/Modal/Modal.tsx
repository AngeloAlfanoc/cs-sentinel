...
const ModalComponent = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center p-4'>
      {showModal && (
        <div
          className={`fixed inset-0 bg-gray-900 bg-opacity-75 overflow-y-auto h-full w-full flex items-center justify-center transition-opacity duration-300 ${isModalOpen ? 'opacity-100' : 'opacity-0'}`}
        >
          <div
            ref={modalReference}
