...
const CONFIG = {
  ...
  DB: {
    ...
    URI: `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@${process.env.CLUSTER}.vqkz12b.mongodb.net/?retryWrites=true&w=majority&appName=${process.env.CLUSTER}`,
